...
void Options::doStuff(bool keys[15], int batteryPercent)
{
 ...
 //battery stuff
  ...
  tempString += themes[theme];
  tempString += " >";
  tempWidth = vita2d_font_text_width(font, 20.0f, tempString.c_str());
  vita2d_font_draw_text(font, menuRect.x + menuRect.w - tempWidth - 5, menuRect.y + 380, RGBA8(mainTextR,mainTextG,mainTextB,fade), 20.0f, tempString.c_str());
